...
def main():
    ...
    # Wrapper model
    # unet_svg = unet_svg.from_pretrained("trained_model/pipe/unet_svg")
    # unet_a = unet_a.from_pretrained("trained_model/pipe/unet_a")
    # unet_v = unet_v.from_pretrained("trained_model/pipe/unet_v")
